...
export function registrarUsuario(event) {
  ...
  if (baseUsuarioExiste) {
    ...
    const usuarioExistente = baseUsuarios.find(
      (user) => user.correo.toLowerCase() == elementos.correoRegister.value.toLowerCase()
    );
  ...
  const usuarioGuardar = new Usuario(
    // baseUsuarios.length,
    elementos.nombreRegister.value
      .replaceAll("<", "&#60")
      .replaceAll(">", "&#62"),
    elementos.apellidoRegister.value
      .replaceAll("<", "&#60")
      .replaceAll(">", "&#62"),
    elementos.correoRegister.value
      .toLowerCase()
      .replaceAll("<", "&#60")
      .replaceAll(">", "&#62"),
    elementos.edadRegister.value
      .replaceAll("<", "&#60")
      .replaceAll(">", "&#62"),
    elementos.claveRegister.value
      .replaceAll("<", "&#60")
      .replaceAll(">", "&#62"),
  ...
  elementos.correoLogin.value = elementos.correoRegister.value;
